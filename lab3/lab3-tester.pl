...
@tests = (
    ...
    [ 'echo hardlinktest > test/file1 ; ln test/file1 test/file2 ; echo success > test/file2 ; cat test/file1 ; rm test/file2',
      'success'
    ],
    ...
    # 20: symlinks
    [ 'ln -s test/symlink.txt link ; echo "hello" >> test/symlink.txt ; diff test/symlink.txt link && echo Same ',
      'Same'
    ],
    # 21 remove symlink
    [' rm link; cat test/symlink.txt',
      'hello'
    ],
